...
<body>
  <div class="container">
    ...
    <h2>Endpoints:</h2>
    <ul>
      <li><strong>GET /api/getAll</strong>: Get all Quran quotes (<a href="https://quranquotes.vercel.app/api/getall" target="_blank">Test</a>)</li>
      <li><strong>GET /api/get/1</strong>: Get a single Quran quote by quote number (<a href="https://quranquotes.vercel.app/api/get/1" target="_blank">Test</a>)</li>
    </ul>

    <h2>Example API Requests:</h2>
    <p>Get all Quran quotes:</p>
    <pre><code>GET /api/getAll</code></pre>

    <p>Get a single Quran quote:</p>
    <pre><code>GET /api/get/1</code></pre>
